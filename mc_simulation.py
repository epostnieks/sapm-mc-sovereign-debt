#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Sovereign Debt / Intergenerational Extraction Floor
===================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Sovereign Debt (Intergenerational Extraction Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "sovereign_debt",
    "domain_name": "Sovereign Debt",
    "theorem": "Intergenerational Extraction Floor",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 35.0,
    "channels": {
        "C1_austerity_welfare_loss": {
            ...
            "high": 106.3,
            "weight": 0.35,
            "description": "Forced austerity: healthcare cuts, education cuts, social safety net erosion. Sources: IMF Article IV, Stuckler & Basu."
        },
        "C2_debt_overhang_growth": {
            ...
            "high": 66.3,
            "weight": 0.25,
            "description": "GDP growth penalty from excessive debt. Debt overhang deters investment. Sources: Reinhart & Rogoff (corrected), IMF."
        },
        "C3_contagion_spillover": {
            ...
            "high": 38.6,
            "weight": 0.2,
            "description": "Sovereign debt crises spread to banking systems and neighbors. Sources: BIS, IMF GFSR."
        },
        "C4_intergenerational_burden": {
            ...
            "high": 26.6,
            "weight": 0.1,
            "description": "Future generations bear debt service without consent. Democratic deficit. Sources: IMF, Piketty."
        },
        "C5_creditor_moral_hazard": {
            ...
            "high": 13.4,
            "weight": 0.1,
            "description": "IMF conditionality, vulture funds, collective action failures. Sources: Stiglitz, Schumacher et al."
        }
    },
    "impossibility_floor": 2.5
}
